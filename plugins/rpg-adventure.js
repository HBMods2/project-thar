...
let handler = async (m, { usedPrefix, command }) => {
	...
	if (user.health < 80) return m.reply(`Requires minimum *❤️ 80 Health* for ${command}!!\n\nType *${usedPrefix}heal* to increase health.\nOr *${usedPrefix}use potion* to use potion.`)
if (new Date - user.lastventure <= co
