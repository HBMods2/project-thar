				...
				const sections = [
					{
						title: `━ ━ ━ ━ 『 MAIN 』 ━ ━ ━ ━`,
						rows: [
							{title: '⚡ PREMIUM', rowId: usedPrefix + 'sewa', description: 'Premium, Donate'},
							{title: '🎫 OWNER', rowId: usedPrefix + 'owner', description: 'Chat P not replying'},
							{title: '📁 Script', rowId: usedPrefix + 'sc', description: 'Original Base'}
						]
					}, {
						title: `━ ━ ━ ━ 『 SUB MENU 』 ━ ━ ━ ━`,
						rows: [
							...
							{title: '🎮 GAMES & FUN', rowId: usedPrefix + 'menufun', description: '⊛ RPG, Quiz, Anonymous'},
							{title: '🐳 GENSHIN IMPACT', rowId: usedPrefix + 'menugenshin', description: '⊜ genshin.dev API'},
							{title: '🔞 NSFW', rowId: usedPrefix + 'menunsfw', description: '◓ This Afakah Feature ?'},
							{title: '👥 GROUP', rowId: usedPrefix + 'menugroup', description: '◒ Commands In Group'},
							{title: '🗺 EDITOR', rowId: usedPrefix + 'menueditor',  description: 'ⓞ Kreasi Foto'},
							{title: '💫 EPHOTO 360', rowId: usedPrefix + 'menuephoto', description: '⦿ Edit Your Photo'},
							{title: '👼🏻 PHOTO OXY', rowId: usedPrefix + 'menuoxy', description: '◐ Edit Photos by Oxy'},
							{title: '🎨 TEXT PRO ME', rowId: usedPrefix + 'menutextpro', description: '◑ Effect Text Creation'},
						]
					}, {
						title: `━ ━ ━ ━ 『 MISC 』 ━ ━ ━ ━`,
						rows: [
